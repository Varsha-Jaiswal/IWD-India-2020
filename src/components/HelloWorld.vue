<template>
  <v-container>
    <v-layout row wrap class="pa-0">
      <v-flex xs12 md12>
        <v-img :src="require('../assets/iwd.jpg')" class="mt-0" height="500"></v-img>
      </v-flex>

      <v-flex xs12 md6 offset-md3 mb-4 mt-4 text-center>
        <h1 class="google-font mb-3">IWD India 2020</h1>
        <p
          class="subheading font-weight-regular google-font"
        ...
        <p class="subheading font-weight-regular google-font">
          <b>Powered By:</b> Women Techmakers
        </p>
      </v-flex>
    </v-layout>
  </v-container>
